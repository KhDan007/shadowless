                    ...
                    <td className="border-b border-border px-3 py-1.5">
                      <div className="flex items-center gap-1.5">
                        <div className="h-1 w-14 overflow-hidden rounded bg-background">
                          <div className="h-full" style={{ width: `${r.confidence}%`, background: r.confidence > 85 ? "var(--risk-low)" : r.confidence > 65 ? "var(--risk-medium)" : "var(--on-surface-variant)" }} />
                        </div>
            ...
            <div className="border-b border-border bg-background px-5 py-4">
              ...
              <div className="mt-3 flex items-center gap-2">
                <div className="h-1 flex-1 overflow-hidden rounded bg-card">
                  <div className="h-full" style={{ width: `${row.confidence}%`, background: row.confidence > 85 ? "var(--risk-low)" : row.confidence > 65 ? "var(--risk-medium)" : "var(--on-surface-variant)" }} />
                </div>
