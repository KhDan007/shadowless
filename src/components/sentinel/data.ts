...
export const TIMELINE_EVENTS: TimelineEvent[] = [
  {
    ...
    kind: "case", risk: "high",
    title: "Открыто дело KZ-2048",
    detail: "Расследование цифровой сети начато по наводке трансграничного отдела ФРМ. Начальный охват: 2 кошелька, 1 Telegram-аккаунт.",
    actor: "Инсп. А. Тұрсынбек · CIB-04",
    caseId: "KZ-2048",
  ...
  },
  {
    ...
    title: "Запущен сбор Telegram",
    detail: "Запущено окно сбора TG-CRAWL-04 по @shadow_node и 3 broadcast-каналам.",
    actor: "TG-CRAWL-04",
    caseId: "KZ-2048",
    entityIds: ["e-tg"],
  },
  {
    ...
    kind: "ai", risk: "high",
    title: "Обнаружено расширение кластера",
    detail: "Модель связала 4 входящих контрагентов TX9z…8kLp с существующим кластером KZ-FIU-118 (+6,2σ выше базового уровня).",
    actor: "AI-движок · corr-v4",
    caseId: "KZ-2048",
    entityIds: ["e-w1", "e-alpha"],
  ...
  },
  {
    ...
    kind: "report",
    title: "Подготовлен отчёт · Трансграничная корреляция кошельков",
    detail: "Аналитик К. Омаров подготовил RPT-2041-007 для совместного разбора с делом KZ-2041.",
    actor: "Аналитик К. Омаров",
    caseId: "KZ-2048",
  ...
  },
  {
    ...
    title: "Кошелёк TX9z…8kLp · зафиксировано первое финансирование",
    detail: "Chain-аналитика зафиксировала первый входящий перевод: 12 400 USDT. Уверенность 99%.",
    actor: "CHAIN-TRC20",
    caseId: "KZ-2048",
    entityIds: ["e-w1"],
    evidenceIds: ["EV-2048-003"],
  },
  {
    ...
    kind: "ai", risk: "high",
    title: "Поведенческое совпадение · операция «NORDWIND» 87%",
    detail: "Темп публикаций и паттерн ротации каналов Объекта Альфа совпадают с архивным отпечатком NORDWIND с подобием 87%.",
    actor: "AI-движок · profile-match",
    caseId: "KZ-2048",
    entityIds: ["e-alpha"],
  ...
  },
  {
    ...
    kind: "note",
    title: "Заметка аналитика · кандидат на эскалацию",
    detail: "Рекомендуется эскалировать Объект Альфа до статуса ОСНОВНОЙ ПОДОЗРЕВАЕМЫЙ при условии подтверждения по линии кошельков. Подключаем алматинское оперативное подразделение.",
    actor: "Аналитик Р. Беқсұлтан",
    caseId: "KZ-2048",
    entityIds: ["e-alpha"],
    pinned: true,
  },
  {
    ...
    title: "Тревога · входящие 0,012 BTC из KZ-FIU-118",
    detail: "Расчётный кошелёк bc1q…m4ah получил средства из отмеченного кластера.",
    actor: "CHAIN-BTC",
    caseId: "KZ-2048",
    entityIds: ["e-w2"],
    evidenceIds: ["EV-2048-015"],
  },
  {
    ...
    kind: "evidence", risk: "medium",
    title: "Роуминг одноразовой SIM · периметр Талгар",
    detail: "Метаданные сотового оператора показывают роуминг, соответствующий движению вдоль периметра Талгар.",
    actor: "MNO-META",
    caseId: "KZ-2048",
    entityIds: ["e-phone"],
  ...
  },
  {
    ...
    kind: "report",
    title: "Опубликована еженедельная сводка",
    detail: "RPT-2048-014 утверждён и направлен руководству CIB-04. 18 страниц, гриф RESTRICTED // MIA-INTERNAL.",
    actor: "Инсп. А. Тұрсынбек · CIB-04",
    caseId: "KZ-2048",
  ...
  },
  {
    ...
    title: "Тревога · брокерский оффер на Tor-форуме",
    detail: "DarkKaz_204 разместил оффер обмена кошельков, совпадающий с сигнатурой кластера.",
    actor: "TOR-FORUM",
    caseId: "KZ-2048",
    entityIds: ["e-forum"],
    evidenceIds: ["EV-2048-022"],
  },
  {
    ...
    kind: "ack",
    title: "Тревога подтверждена · брокерский оффер на Tor-форуме",
    detail: "Аналитик подтвердил AL-2048-022 и отметил для расширения окна наблюдения.",
    actor: "Аналитик Р. Беқсұлтан",
    caseId: "KZ-2048",
    entityIds: ["e-forum"],
  },
  {
    ...
    kind: "evidence", risk: "medium",
    title: "Гео-кластер · Алматы, Бостандык",
    detail: "Три пинга устройств в радиусе 80 м, локализованные в Бостандыкском районе.",
    actor: "GEO-PING",
    caseId: "KZ-2048",
    entityIds: ["e-loc"],
  ...
  },
  {
    ...
    title: "Тревога · перевод, смежный с миксером, на TX9z…8kLp",
    detail: "Исходящие 0,84 USDT на известный сервисный контракт, смежный с миксером.",
    actor: "CHAIN-TRC20",
    caseId: "KZ-2048",
    entityIds: ["e-w1"],
  ...
  },
  {
    ...
    title: "Поставлено в очередь · подготовлен запрос MLAT",
    detail: "Подготовлен черновик запроса MLAT для трансграничной трассировки TRC-20 расчётного кошелька. Ожидает визы руководителя.",
    actor: "Инсп. А. Тұрсынбек · CIB-04",
    caseId: "KZ-2048",
    entityIds: ["e-w1"],
    pinned: true,
  },
  {
    ...
    title: "Broadcast · «партия рассылки 04»",
    detail: "Синхронизированный broadcast в 3 Telegram-каналах в окне 90 секунд.",
    actor: "TG-CRAWL-04",
    caseId: "KZ-2048",
    entityIds: ["e-tg", "e-alpha"],
